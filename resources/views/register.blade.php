...
<body>
    ...
    <main class="main">
        ...
        <footer class="main" style=" margin-top: 2%; border: 1px solid;">
            <section class="section-padding footer-mid" style="background-color: #fff; padding: 50px;  ">
                <div class="container pt-15 pb-20">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="widget-about font-md mb-md-5 mb-lg-0">

                                <h5 class="mt-3 mb-10 fw-600 " style="color: black">Contact</h5>
                                <p style="color: black">
                        ...
                        <div class="col-lg-2 col-md-3">
                            <h5 class="widget-title " style="color: black">About</h5>
                        ...
                        <div class="col-lg-2  col-md-3">
                            ...
                            <ul class="footer-list ">
                                <li><a href="my-account.html" style="color: black">My Account</a></li>
                        ...
                        <div class="col-lg-4 mob-center">
                            <h5 class="widget-title" style="color: black">Install App</h5>
                            <div class="row">
                                <div class="col-md-8 col-lg-12">
                                    <p style="color: black">From App Store or Google Play</p>
                                    <div class="download-app  mob-app">
                                ...
                                <div class="col-md-4 col-lg-12 mt-md-3 mt-lg-0">
                                    <p style="color: black">Secured Payment Gateways</p>
